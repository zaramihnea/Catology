// Dafny program lab4.dfy compiled into C#
...
// Command-line arguments: build --output bin/lab4 /Users/zaramihnea/Developer/Uni/An3Sem1/VDPD/lab4/lab4.dfy
// lab4.dfy
...
method incrementCounter(c: NaturalCounter?)
  ...
  modifies if c != null then {c} else {}
  ensures c != null ==> c.Valid() && c.counter == old(c.counter) + 1
  ensures c == null ==> true
  decreases c
{
  if c != null {
...
namespace _module {
  ...
  public partial class __default {
    public static void setCell(Cell cell, BigInteger x)
    {
      (cell).setContents(x);
    }
    public static void setBoth(Cell cell1, BigInteger x, Cell cell2, BigInteger y)
    {
      (cell1).setContents(x);
      (cell2).setContents(y);
    }
  ...
  public partial class Cell {
    public Cell() {
      this.contents = BigInteger.Zero;
    }
    public BigInteger contents {get; set;}
    public void __ctor()
    {
      (this).contents = BigInteger.Zero;
    }
    public void fromInt(BigInteger x)
    {
      (this).contents = x;
    }
    public void setContents(BigInteger x)
    {
      (this).contents = x;
    }
  ...
  public partial class EvenNumber {
    ...
    public bool Valid() {
      return (Dafny.Helpers.EuclideanModulus(this.x, new BigInteger(2))).Sign == 0;
    }
    public void __ctor()
    {
      (this).x = BigInteger.Zero;
    ...
    {
      (this).x = (this.x) + (new BigInteger(2));
    }
    public void square()
    {
      (this).x = (this.x) * (new BigInteger(2));
  ...
  public partial class NaturalCounter {
    public NaturalCounter() {
      this.counter = BigInteger.Zero;
    }
    public BigInteger counter {get; set;}
    public bool Valid() {
      return (this.counter).Sign != -1;
    }
    public void __ctor()
    {
      (this).counter = BigInteger.Zero;
