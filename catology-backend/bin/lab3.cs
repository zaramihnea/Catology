// Dafny program lab3.dfy compiled into C#
...
// Command-line arguments: build --output bin/lab3 /Users/zaramihnea/Developer/Uni/An3Sem1/VDPD/lab3/lab3.dfy
// lab3.dfy

method containsDuplicates(arr: array<int>) returns (result: bool)
  decreases arr
{
  for i: int := 0 to arr.Length {
    for j: int := i + 1 to arr.Length {
      if arr[i] == arr[j] {
        result := true;
        return;
      }
...
method containsDuplicatesGeneric<T(==)>(arr: array<T>) returns (result: bool)
  decreases arr
{
  for i: int := 0 to arr.Length {
    for j: int := i + 1 to arr.Length {
...
method containsDuplicatesPos(arr: array<int>) returns (result: Maybe<(int, int)>)
  decreases arr
{
  for i: int := 0 to arr.Length {
    for j: int := i + 1 to arr.Length {
...
method DivideByX(x: int) returns (alt: Status<int>)
  decreases x
{
  if x == 0 {
    return Failure(""division by 0"");
  } else {
    return Success(100 / x);
  }
}

method elefant(x: int) returns (result: Status<int>)
  decreases x
{
  var xOther: int :- DivideByX(x);
  return Success(xOther + 10);
}

method swapElementse<T>(arr: array<T>, i: int, j: int)
...
method insert(arr: array<int>, n: int)
...
method insertSort(arr: array<int>)
  modifies arr
  decreases arr
{
  for n: int := 0 to arr.Length {
    insert(arr, n);
  }
}

method unique(arr1: array<int>) returns (arr2: array<int>)
  decreases arr1
{
  arr2 := new int[arr1.Length];
  var count := 0;
  for i: int := 0 to arr1.Length {
    for j: int := 0 to count {
      if arr1[i] != arr2[j] {
        arr2[count] := arr1[i];
        count := count + 1;
      }
...
method unique2<T(==,0)>(a: array<T>) returns (b: array<T>)
  requires a.Length > 0
  decreases a
{
  var n := a.Length;
...
method compact(arr: array<int>) returns (n: int)
  modifies arr
  decreases arr
{
  if arr.Length == 0 {
  ...
  var write_index := 0;
  for read_index: int := 1 to arr.Length {
    if read_index < arr.Length && write_index < arr.Length && arr[read_index] != arr[write_index] {
      write_index := write_index + 1;
      if write_index < arr.Length {
...
datatype Status<T> = Success(value: T) | Failure(error: string) {
  predicate IsFailure()
    decreases this
  {
    this.Failure?
  ...
  function PropagateFailure(): Status<T>
    decreases this
  {
    this
  }
...
namespace _module {
  ...
  public partial class __default {
    public static bool containsDuplicates(BigInteger[] arr)
    {
      bool result = false;
      BigInteger _hi0 = new BigInteger((arr).Length);
      for (BigInteger _0_i = BigInteger.Zero; _0_i < _hi0; _0_i++) {
        BigInteger _hi1 = new BigInteger((arr).Length);
        for (BigInteger _1_j = (_0_i) + (BigInteger.One); _1_j < _hi1; _1_j++) {
          if (((arr)[(int)(_0_i)]) == ((arr)[(int)(_1_j)])) {
            result = true;
            return result;
          }
        }
    ...
    public static bool containsDuplicatesGeneric<__T>(__T[] arr)
    {
      bool result = false;
      BigInteger _hi0 = new BigInteger((arr).Length);
      for (BigInteger _0_i = BigInteger.Zero; _0_i < _hi0; _0_i++) {
        BigInteger _hi1 = new BigInteger((arr).Length);
        for (BigInteger _1_j = (_0_i) + (BigInteger.One); _1_j < _hi1; _1_j++) {
          if (object.Equals((arr)[(int)(_0_i)], (arr)[(int)(_1_j)])) {
            result = true;
            return result;
          }
        }
    ...
    public static _IMaybe<_System._ITuple2<BigInteger, BigInteger>> containsDuplicatesPos(BigInteger[] arr)
    {
      _IMaybe<_System._ITuple2<BigInteger, BigInteger>> result = Maybe<_System._ITuple2<BigInteger, BigInteger>>.Default();
      BigInteger _hi0 = new BigInteger((arr).Length);
      for (BigInteger _0_i = BigInteger.Zero; _0_i < _hi0; _0_i++) {
        BigInteger _hi1 = new BigInteger((arr).Length);
        for (BigInteger _1_j = (_0_i) + (BigInteger.One); _1_j < _hi1; _1_j++) {
          if (((arr)[(int)(_0_i)]) == ((arr)[(int)(_1_j)])) {
            result = _module.Maybe<_System._ITuple2<BigInteger, BigInteger>>.create_Just(_System.Tuple2<BigInteger, BigInteger>.create(_0_i, _1_j));
            return result;
          }
        }
      }
      result = _module.Maybe<_System._ITuple2<BigInteger, BigInteger>>.create_Nothing();
      return result;
      return result;
    }
    public static _IStatus<BigInteger> DivideByX(BigInteger x)
    {
      _IStatus<BigInteger> alt = Status<BigInteger>.Default();
      if ((x).Sign == 0) {
        alt = _module.Status<BigInteger>.create_Failure(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("division by 0"));
        return alt;
      } else {
        alt = _module.Status<BigInteger>.create_Success(Dafny.Helpers.EuclideanDivision(new BigInteger(100), x));
        return alt;
      }
      return alt;
    }
    public static _IStatus<BigInteger> elefant(BigInteger x)
    {
      _IStatus<BigInteger> result = Status<BigInteger>.Default();
      _IStatus<BigInteger> _0_valueOrError0 = Status<BigInteger>.Default();
      _IStatus<BigInteger> _out0;
      _out0 = __default.DivideByX(x);
      _0_valueOrError0 = _out0;
      if ((_0_valueOrError0).IsFailure()) {
        result = (_0_valueOrError0).PropagateFailure();
        return result;
      }
      BigInteger _1_xOther;
      _1_xOther = (_0_valueOrError0).Extract();
      result = _module.Status<BigInteger>.create_Success((_1_xOther) + (new BigInteger(10)));
      return result;
      return result;
    }
    public static void swapElementse<__T>(__T[] arr, BigInteger i, BigInteger j)
    {
      __T _0_temp;
      _0_temp = (arr)[(int)(i)];
      (arr)[(int)((i))] = (arr)[(int)(j)];
    ...
    public static void insert(BigInteger[] arr, BigInteger n)
    {
      BigInteger _0_key;
      _0_key = (arr)[(int)(n)];
      BigInteger _1_i;
      _1_i = (n) - (BigInteger.One);
      while (((_1_i).Sign != -1) && (((arr)[(int)(_1_i)]) > (_0_key))) {
        BigInteger _index0 = (_1_i) + (BigInteger.One);
        (arr)[(int)(_index0)] = (arr)[(int)(_1_i)];
        _1_i = (_1_i) - (BigInteger.One);
      }
      BigInteger _index1 = (_1_i) + (BigInteger.One);
      (arr)[(int)(_index1)] = _0_key;
    }
    public static void insertSort(BigInteger[] arr)
    {
      BigInteger _hi0 = new BigInteger((arr).Length);
      for (BigInteger _0_n = BigInteger.Zero; _0_n < _hi0; _0_n++) {
        __default.insert(arr, _0_n);
      }
    }
    public static BigInteger[] unique(BigInteger[] arr1)
    {
      BigInteger[] arr2 = new BigInteger[0];
      BigInteger[] _nw0 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger((arr1).Length), "array size exceeds memory limit")];
      arr2 = _nw0;
      BigInteger _0_count;
      _0_count = BigInteger.Zero;
      BigInteger _hi0 = new BigInteger((arr1).Length);
      for (BigInteger _1_i = BigInteger.Zero; _1_i < _hi0; _1_i++) {
        BigInteger _hi1 = _0_count;
        for (BigInteger _2_j = BigInteger.Zero; _2_j < _hi1; _2_j++) {
          if (((arr1)[(int)(_1_i)]) != ((arr2)[(int)(_2_j)])) {
            (arr2)[(int)((_0_count))] = (arr1)[(int)(_1_i)];
    ...
    public static __T[] unique2<__T>(Dafny.TypeDescriptor<__T> _td___T, __T[] a)
    {
      __T[] b = new __T[0];
      BigInteger _0_n;
      _0_n = new BigInteger((a).Length);
      __T[] _1_result;
      __T[] _nw0 = Dafny.ArrayHelpers.InitNewArray1<__T>(_td___T.Default(), Dafny.Helpers.ToIntChecked(_0_n, "array size exceeds memory limit"));
      _1_result = _nw0;
      BigInteger _2_k;
      _2_k = BigInteger.Zero;
      BigInteger _hi0 = (_0_n) - (BigInteger.One);
      for (BigInteger _3_i = BigInteger.Zero; _3_i < _hi0; _3_i++) {
        bool _4_found;
        _4_found = false;
        BigInteger _hi1 = _2_k;
        for (BigInteger _5_j = BigInteger.Zero; _5_j < _hi1; _5_j++) {
          if (object.Equals((_1_result)[(int)(_5_j)], (a)[(int)(_3_i)])) {
            _4_found = true;
            goto after_0_0;
          }
        continue_0_0: ;
      ...
      after_0_0: ;
        if (!(_4_found)) {
          (_1_result)[(int)((_2_k))] = (a)[(int)(_3_i)];
          _2_k = (_2_k) + (BigInteger.One);
        }
      }
      __T[] _6_barray;
      __T[] _nw1 = Dafny.ArrayHelpers.InitNewArray1<__T>(_td___T.Default(), Dafny.Helpers.ToIntChecked(_2_k, "array size exceeds memory limit"));
      _6_barray = _nw1;
      BigInteger _hi2 = _2_k;
      for (BigInteger _7_i = BigInteger.Zero; _7_i < _hi2; _7_i++) {
        (_6_barray)[(int)((_7_i))] = (_1_result)[(int)(_7_i)];
      }
      b = _6_barray;
      return b;
      return b;
    }
    public static BigInteger compact(BigInteger[] arr)
    {
      ...
      BigInteger _0_write__index;
      _0_write__index = BigInteger.Zero;
      BigInteger _hi0 = new BigInteger((arr).Length);
      for (BigInteger _1_read__index = BigInteger.One; _1_read__index < _hi0; _1_read__index++) {
        if ((((_1_read__index) < (new BigInteger((arr).Length))) && ((_0_write__index) < (new BigInteger((arr).Length)))) && (((arr)[(int)(_1_read__index)]) != ((arr)[(int)(_0_write__index)]))) {
          _0_write__index = (_0_write__index) + (BigInteger.One);
          if ((_0_write__index) < (new BigInteger((arr).Length))) {
            (arr)[(int)((_0_write__index))] = (arr)[(int)(_1_read__index)];
          }
        }
      }
      n = (_0_write__index) + (BigInteger.One);
      return n;
      return n;
    }
  }
  ...
  public abstract class Maybe<T> : _IMaybe<T> {
    ...
    public static _IMaybe<T> create_Just(T what) {
      return new Maybe_Just<T>(what);
    }
    ...
    public _IMaybe<T> PropagateFailure() {
      return this;
    }
    public T Extract() {
      return (this).dtor_what;
    }
  }
  public class Maybe_Just<T> : Maybe<T> {
    public readonly T _what;
    public Maybe_Just(T what) : base() {
      this._what = what;
    }
    public override _IMaybe<__T> DowncastClone<__T>(Func<T, __T> converter0) {
      if (this is _IMaybe<__T> dt) { return dt; }
      return new Maybe_Just<__T>(converter0(_what));
    }
    public override bool Equals(object other) {
      var oth = other as Maybe_Just<T>;
      return oth != null && object.Equals(this._what, oth._what);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._what));
      return (int) hash;
    }
    public override string ToString() {
      string s = "Maybe.Just";
      s += "(";
      s += Dafny.Helpers.ToString(this._what);
      s += ")";
      return s;
    }
  }
  ...
  public interface _IStatus<T> {
    bool is_Success { get; }
    bool is_Failure { get; }
    T dtor_value { get; }
    Dafny.ISequence<Dafny.Rune> dtor_error { get; }
    _IStatus<__T> DowncastClone<__T>(Func<T, __T> converter0);
    bool IsFailure();
    _IStatus<T> PropagateFailure();
    T Extract();
  }
  public abstract class Status<T> : _IStatus<T> {
    public Status() {
    }
    public static _IStatus<T> Default() {
      return create_Failure(Dafny.Sequence<Dafny.Rune>.Empty);
    }
    public static Dafny.TypeDescriptor<_IStatus<T>> _TypeDescriptor() {
      return new Dafny.TypeDescriptor<_IStatus<T>>(Status<T>.Default());
    }
    public static _IStatus<T> create_Success(T @value) {
      return new Status_Success<T>(@value);
    }
    public static _IStatus<T> create_Failure(Dafny.ISequence<Dafny.Rune> error) {
      return new Status_Failure<T>(error);
    }
    public bool is_Success { get { return this is Status_Success<T>; } }
    public bool is_Failure { get { return this is Status_Failure<T>; } }
    public T dtor_value {
      get {
        var d = this;
        return ((Status_Success<T>)d)._value;
      }
    }
    public Dafny.ISequence<Dafny.Rune> dtor_error {
      get {
        var d = this;
        return ((Status_Failure<T>)d)._error;
      }
    }
    public abstract _IStatus<__T> DowncastClone<__T>(Func<T, __T> converter0);
    public bool IsFailure() {
      return (this).is_Failure;
    }
    public _IStatus<T> PropagateFailure() {
      return this;
    }
    public T Extract() {
  ...
  public class Status_Success<T> : Status<T> {
    public readonly T _value;
    public Status_Success(T @value) : base() {
      this._value = @value;
    }
    public override _IStatus<__T> DowncastClone<__T>(Func<T, __T> converter0) {
      if (this is _IStatus<__T> dt) { return dt; }
      return new Status_Success<__T>(converter0(_value));
    }
    public override bool Equals(object other) {
      var oth = other as Status_Success<T>;
  ...
  public class Status_Failure<T> : Status<T> {
    public readonly Dafny.ISequence<Dafny.Rune> _error;
    public Status_Failure(Dafny.ISequence<Dafny.Rune> error) : base() {
      this._error = error;
    }
    public override _IStatus<__T> DowncastClone<__T>(Func<T, __T> converter0) {
      if (this is _IStatus<__T> dt) { return dt; }
      return new Status_Failure<__T>(_error);
    }
    public override bool Equals(object other) {
      var oth = other as Status_Failure<T>;
